...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        List<Method> methods = getMethodList(Arrays.asList("before", route.getAction(), "after"), pageClass);
        ...
        try {
            ...
            throw new ServletException("Can't render template [pageClass=" + pageClass + ", method=" + methods + "].", e);
        }
    }

    private List<Method> getMethodList(List<String> methodNames, Class<?> pageClass) {
